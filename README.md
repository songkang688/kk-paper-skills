...
对路由说发表前最终审查，它会依次跑全局一致性检查（术语、符号、数值、主张对证据、图表引用、结构承诺）、格式合规检查（联网抓官方模板要求，实测页数、版式、字体嵌入、图表分辨率与图注、参考文献样式、匿名方式，出官方要求对实测值的合规对照表）、`paper-skill` 投稿材料检查单、`scipilot` 语言 lint，输出按 P0/P1/P2 分级的终检报告。
